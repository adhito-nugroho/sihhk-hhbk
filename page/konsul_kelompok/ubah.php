<?php
  ...
  $sql = $koneksi->query("select * from tb_konsul_kelompok where id_konsul_kelompok='$kode'");
            ...
            <form method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" value="<?php echo $data['peserta']?>" name="peserta"/>
                </div>
...
<?php 
  if (isset($_POST['simpan'])) {
    ...
    $sql = $koneksi->query("UPDATE tb_konsul_kelompok SET tgl_pelaksanaan=STR_TO_DATE('$tanggal', '%d/%m/%Y'),nip='$nip', jam='$jam',kelompok='$kelompok',desa='$desa',kec='$kec',kab='$kab',peserta='$peserta',materi='$materi',masalah='$masalah', pemecahan='$pemecahan' WHERE id_konsul_kelompok ='$kode' ");
