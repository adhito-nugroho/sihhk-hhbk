...
<?php 
  if (isset($_POST['simpan'])) {
    ...
    $sql = $koneksi->query("insert into tb_anjangkarya (nip,tgl_pelaksanaan,jam,kelompok,desa,kec,kab,lokasi,materi,uraian) values('$nip',STR_TO_DATE('$tanggal', '%d/%m/%Y'),'$jam','$kelompok','$desa','$kec','$kab','$lokasi','$materi','$uraian')");
