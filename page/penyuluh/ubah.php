...
<?php 
  if (isset($_POST['simpan'])){
    ...
    $sql = $koneksi->query("UPDATE tb_user SET username='$username',nama='$nama',password='$pass',level='$level',foto='$foto' WHERE id_user='$id'");
    if($sql){
    ?>
    ...
    $sql = $koneksi->query("UPDATE tb_user SET username='$username',nama='$nama',password='$pass',level='$level' WHERE id='$id'");
    if($sql){
    ?>
        <script type="text/javascript">
          alert ("Data Berhasil Disimpan")
