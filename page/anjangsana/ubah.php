<?php
  ...
  $sql = $koneksi->query("select * from tb_anjangsana where id_anjangsana='$kode'");
...
<?php 
  if (isset($_POST['simpan'])) {
    ...
    $sql = $koneksi->query("UPDATE tb_anjangsana SET tgl_pelaksanaan=STR_TO_DATE('$tanggal', '%d/%m/%Y'), jam='$jam',kelompok='$kelompok',desa='$desa',kec='$kec',kab='$kab',lokasi='$lokasi',materi='$materi',uraian='$uraian' WHERE id_anjangsana ='$kode' ");
