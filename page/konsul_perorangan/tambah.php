...
<?php 
  if (isset($_POST['simpan'])) {
    ...
    $sql = $koneksi->query("insert into tb_konsul_perorangan (nip,tgl_pelaksanaan,jam,kelompok,desa,kec,kab,materi,masalah,pemecahan) values('$nip',STR_TO_DATE('$tanggal', '%d/%m/%Y'),'$jam','$kelompok','$desa','$kec','$kab','$materi','$masalah','$pemecahan')");
